...
public class UserProfileActivity extends BaseActivity
	...
	private void initView() {
		...
		headPhotoUpdate = (ImageView) findViewById(
				R.id.user_head_headphoto_update);
		tvUsername = (TextView) findViewById(R.id.user_username);
		tvNickName = (TextView) findViewById(R.id.user_nickname);
		rlNickName = (RelativeLayout) findViewById(R.id.rl_nickname);
		iconRightArrow = (ImageView) findViewById(R.id.ic_right_arrow);
		mRewardBtn = (Button) findViewById(R.id.em_btn_user_profile_reward);
	}
	...
	private void initListener() {
		...
		if (username != null) {
			if (username.equals(EMClient.getInstance().getCurrentUser())) {
				...
				// 非当前用户，显示打赏按钮
				findViewById(R.id.em_view_divider).setVisibility(View.VISIBLE);
				mRewardBtn.setVisibility(View.VISIBLE);
				mRewardBtn.setOnClickListener(this);
			}
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_nickname:
			...
			new AlertDialog.Builder(this).setTitle(R.string.setting_nickname)
					.setIcon(android.R.drawable.ic_dialog_info)
					.setView(editText).setPositiveButton(R.string.dl_ok,
								...
								public void onClick(DialogInterface dialog,
									...
									if (TextUtils.isEmpty(nickString)) {
										Toast.makeText(UserProfileActivity.this,
												getString(
														R.string.toast_nick_not_isnull),
			...
			break;
		case R.id.em_btn_user_profile_reward:// 打赏
			doRewardClick();
			break;
		default:
			break;
	 ...
	 * 点击打赏按钮
	 */
	private void doRewardClick() {
		RPSendRewardParams params = new RPSendRewardParams();
		// TODO czhang 加入风控信息
		params.targetUserId = username;
		EaseUser easeUser = RPHelper.getEaseUser(username);
		params.targetUserName = easeUser != null ? easeUser.getNickname()
				: username;
		params.targetAvatar = easeUser.getAvatar();
		// 测试加入风控信息
		params.riskInfo = RequestUtils.genTestRiskInfo();
		RPResultHandler<RPSendResult> callback = new RPResultHandler<RPSendResult>() {
			@Override
			public void onSuccess(RPSendResult result) {
				Toast.makeText(UserProfileActivity.this, "打赏成功",
						Toast.LENGTH_SHORT).show();
			}
		};
		RedPacketManager.sendRedPacket(this, params, callback, null);
	}
	...
	private void uploadHeadPhoto() {
		...
		builder.setItems(
				new String[] { getString(R.string.dl_msg_take_photo),
				...
				if (!updatenick) {
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							Toast.makeText(UserProfileActivity.this,
									getString(
											R.string.toast_updatenick_success),
									Toast.LENGTH_SHORT).show();
